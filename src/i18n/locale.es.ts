...
export const esMessages = {
  ...
  audit: {
    ...
    /** Cuando el API solo devuelve el id de usuario y no hay nombre resuelto. */
    userNameUnavailable: 'Sin nombre de usuario',
  },
  app: {
    title: 'Timci',
  },
  ...
  pages: {
    ...
    tenants: {
      ...
      activate: 'Activar',
      deactivate: 'Desactivar',
      activated: 'Inquilino activado',
      deactivated: 'Inquilino desactivado',
      toggleError: 'No se pudo cambiar el estado',
      confirmActivateTitle: '¿Activar inquilino?',
      confirmActivateBody: 'Quedará activo y podrá usarse en asignaciones y operaciones.',
    ...
    roles: {
      ...
      toggleError: 'No se pudo cambiar el estado',
      confirmActivateTitle: '¿Activar rol?',
      confirmActivateBody: 'Quedará activo y sus permisos volverán a aplicarse.',
  ...
  table: {
    /** Etiquetas para valores API `physical_person` / `legal_person`. */
    personTypeLabels: {
  ...
  create: {
    ...
    customer: {
      ...
      country: 'País',
      entity: 'Entidad',
      entityFromHeaderHint:
        'La entidad del cliente es la organización seleccionada en la barra superior (selector de inquilino).',
      priceList: 'Lista de precios',
      defaultCurrency: 'Moneda por defecto',
      personType: 'Tipo de persona',
      documentType: 'Tipo de documento',
      ...
      moveContactUp: 'Subir',
      moveContactDown: 'Bajar',
      contactName: 'Nombre del contacto',
      contactEmail: 'Correo',
      contactPhone: 'Teléfono',
      notifySales: 'Notif. ventas',
      notifyCreditos: 'Notif. créditos',
      notifyDebits: 'Notif. débitos',
      notifyCollections: 'Notif. cobranzas',
      notifyOverduePayments: 'Notif. pagos vencidos',
      contactsMinOne: 'Debe existir al menos un contacto.',
    },
  },
} as const;
